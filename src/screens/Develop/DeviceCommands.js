...
export const DeviceCommands = () => {
  ...
  return VerticalLayout(
    ...
    VerticalLayout(
      ...
      h2(() => "Command Id: " + command), // NAME OF THE COMMAND?
      h2(() => "Result: " + commandStatus),
      span(() => commandStatusVerbose),
      // PARAMS
      Object.keys(params).map((p) => span(() => p + " : " + params[p]))
    )
  );
};
